...
import com.wanwujinhua.sell.utils.JsonUtil;
import com.wanwujinhua.sell.utils.MathUtil;
 ...
 * @desc ：支付服务impl
 * @auth ：pdp
 * @date ：Created in 2019/3/19 15:49
 */
@Service
@Slf4j
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        if (!MathUtil.equals(payResponse.getOrderAmount(), orderDTO.getOrderAmount().doubleValue())) {
            ...
            throw new SellException(ResultEnum.WXPAY_NOTIFY_MONEY_VERIFY__ERROR);
        }
